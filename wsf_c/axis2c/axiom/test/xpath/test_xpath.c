...
cl.exe /nologo /D "WIN32" /D "_WINDOWS" /D "_MBCS" /I %WSFC_HOME%\include /c *.c
link.exe /LIBPATH:%WSFC_HOME%\lib axutil.lib axiom.lib axis2_parser.lib axis2_engine.lib /OUT:test.exe *.obj
*/
#include <stdio.h>
#include <axiom.h>
