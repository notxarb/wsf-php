...
#ifndef WIN32
    fprintf(stdout, "\t-f LOG_FILE\t log file, default is $WSFC_HOME/logs/axis2.log"
        "\n\t\t\t or axis2.log in current folder if WSFC_HOME not set\n");
#else
    fprintf(stdout,
        "\t-f LOG_FILE\t log file, default is %%WSFC_HOME%%\\logs\\axis2.log"
        "\n\t\t\t or axis2.log in current folder if WSFC_HOME not set\n");
#endif
    fprintf(stdout,
